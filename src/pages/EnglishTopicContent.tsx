  ...
  return <div className="min-h-screen blur-bg">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold mb-6 md:text-4xl">
            {currentTopic.title}
          </h1>
        </div>

        <div className="max-w-4xl mx-auto space-y-8">
          <EnglishTopicContentDisplay title={currentTopic.title} english={currentTopic.english} isRecording={isRecording} onStartRecording={startRecording} onStopRecording={stopRecording} />

          <SpeechRecorder originalText={currentTopic.english} title={currentTopic.title} audioBlob={audioBlob} />
