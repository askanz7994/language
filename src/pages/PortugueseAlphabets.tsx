...
const PortugueseAlphabets = () => {
  ...
  const playAudio = (letter: string) => {
    console.log(`Playing audio for Portuguese letter: ${letter}`);
    ...
    <div className="min-h-screen blur-bg">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">Alfabeto Português (Portuguese Alphabet)</h1>
...
export default PortugueseAlphabets;
