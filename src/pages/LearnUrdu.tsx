      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Master the language of poetry and literature
          </p>
        </div>

        <div className="grid md:grid-cols-4 gap-8 max-w-5xl mx-auto">
          <Link to="/urdu/alphabets">
            <div className="language-card text-center cursor-pointer">
              ...
              <p className="text-muted-foreground mb-6">
                Master the Urdu alphabet with pronunciation guide
              </p>
          ...
          <Link to="/urdu/words">
            <div className="language-card text-center cursor-pointer">
              ...
              <p className="text-muted-foreground mb-6">
                Build your Urdu vocabulary with essential words and phrases
              </p>
              <Button className="glow-button w-full">
                Explore Words
              </Button>
          ...
          <Link to="/urdu/paragraph">
            <div className="language-card text-center cursor-pointer">
              <BookOpen className="h-12 w-12 text-primary mx-auto mb-4" />
              <h2 className="text-2xl font-bold mb-3">Paragraphs</h2>
              <p className="text-muted-foreground mb-6">
                Practice reading and understanding Urdu through contextual paragraphs
              </p>
              <Button className="glow-button w-full">
                Read Paragraphs
              </Button>
