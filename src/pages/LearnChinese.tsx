      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Explore the world's most spoken language
          </p>
        </div>

        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          <Link to="/chinese/alphabets">
            <div className="language-card text-center cursor-pointer">
              ...
              <p className="text-muted-foreground mb-6">
                Learn Chinese Pinyin initials, finals, and tones
              </p>
          ...
          <Link to="/chinese/numbers">
            <div className="language-card text-center cursor-pointer">
              ...
              <p className="text-muted-foreground mb-6">
                Learn Chinese numbers from 1 to 100 with pronunciation and examples
              </p>
              <Button className="glow-button w-full">
          ...
          <Link to="/chinese/paragraph">
            <div className="language-card text-center cursor-pointer">
              <BookOpen className="h-12 w-12 text-primary mx-auto mb-4" />
              <h2 className="text-2xl font-bold mb-3">Paragraphs</h2>
              <p className="text-muted-foreground mb-6">
                Practice reading and understanding Chinese through contextual paragraphs
              </p>
              <Button className="glow-button w-full">
                Read Paragraphs
              </Button>
